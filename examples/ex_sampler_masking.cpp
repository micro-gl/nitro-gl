...
int main() {
    ...
    auto on_init = [](SDL_Window *, void *) {
        ...
        masking_sampler<masks::chrome_mode::alpha_channel> sampler_1 { &tex_sampler_3, &tex_sampler_4 };
        masking_sampler<masks::chrome_mode::red_channel> sampler_2 { &tex_sampler_3, &tex_sampler_5 };

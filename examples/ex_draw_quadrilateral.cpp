...
int main() {
    ...
    auto on_init = [](SDL_Window *, void *) {
        ...
        auto tex_sampler_3 = texture_sampler<false>(Resources::loadTexture("assets/images/uv_256.png", false));
        auto tex_sampler_4 = texture_sampler<true>(Resources::loadTexture("assets/images/uv_256.png", true));

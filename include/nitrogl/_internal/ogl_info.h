...
// if VAO was not asked specifically, let's try to infer it
    ...
    // fits both gl>=3.0, and gl-es>=3.0
        ...
        #endif
    #else
        #if (NITROGL_OPENGL_MAJOR_VERSION==2) and (NITROGL_OPENGL_MAJOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 110"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==2) and (NITROGL_OPENGL_MAJOR_VERSION==1)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 120"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) and (NITROGL_OPENGL_MAJOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 130"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) and (NITROGL_OPENGL_MAJOR_VERSION==1)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 140"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) and (NITROGL_OPENGL_MAJOR_VERSION==2)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 150"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) and (NITROGL_OPENGL_MAJOR_VERSION==3)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 330"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 400"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==1)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 410"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==2)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 420"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==3)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 430"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==4)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 440"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==5)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 450"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) and (NITROGL_OPENGL_MAJOR_VERSION==6)

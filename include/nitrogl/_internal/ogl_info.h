...
// if VAO was not asked specifically, let's try to infer it
    ...
    // fits both gl>=3.0, and gl-es>=3.0
        ...
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) && (NITROGL_OPENGL_MINOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 300 es"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) && (NITROGL_OPENGL_MINOR_VERSION==1)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 310 es"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) && (NITROGL_OPENGL_MINOR_VERSION==2)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 320 es"
        #else
            #define NITROGL_OPENGL_GLSL_VERSION "#version 300 es"
        #endif
    #else
        #if (NITROGL_OPENGL_MAJOR_VERSION==2) && (NITROGL_OPENGL_MINOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 110"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==2) && (NITROGL_OPENGL_MINOR_VERSION==1)
        ...
        #elif (NITROGL_OPENGL_MAJOR_VERSION==3) && (NITROGL_OPENGL_MINOR_VERSION==3)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 330"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==0)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 400"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==1)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 410"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==2)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 420"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==3)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 430"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==4)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 440"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==5)
            #define NITROGL_OPENGL_GLSL_VERSION "#version 450"
        #elif (NITROGL_OPENGL_MAJOR_VERSION==4) && (NITROGL_OPENGL_MINOR_VERSION==6)

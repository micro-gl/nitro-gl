...
#define TWO_PI    6.2831853072
        ...
        number sin_bhaskara_cpu(number radians) {
            const auto pii = nitrogl::math::pi<number>();
            const auto pii2 = nitrogl::math::pi<number>()*number(2);
        ...
        number cos_bhaskara_cpu(number radians) {
            return sin_bhaskara_cpu<number>(radians + nitrogl::math::half_pi<number>());
        }

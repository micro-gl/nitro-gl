...
//                result.z = one;
        ...
        **/
        ...
        static mat4<number> angleAt(const vertex3<number> & position,
            ...
            number cx = nitrogl::math::cos(pitch);
            // rotation angle about Y-axis (yaw)
            number sy = nitrogl::math::sin(yaw);
            number cy = nitrogl::math::cos(yaw);
            // rotation angle about Z-axis (roll)
            number sz = nitrogl::math::sin(roll);
            number cz = nitrogl::math::cos(roll);
